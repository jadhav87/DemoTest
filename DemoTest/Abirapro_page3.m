...
@interface Abirapro_page3 ()

@end

@implementation Abirapro_page3
@synthesize web;
...
- (void)viewDidLoad
{
    ...
    NSString *path=[[NSBundle mainBundle] pathForResource:@"slide03" ofType:@"html" inDirectory:@"Abirapro"];
