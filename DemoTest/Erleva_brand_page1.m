...
@interface Erleva_brand_page1 ()

@end

@implementation Erleva_brand_page1
@synthesize web;
...
- (void)viewDidLoad
{
    ...
    NSString *path=[[NSBundle mainBundle] pathForResource:@"slide02" ofType:@"html" inDirectory:@"Erleva"];
