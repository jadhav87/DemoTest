...
@interface Bortract_brand_Home ()

@end

@implementation Bortract_brand_Home
@synthesize web;
...
- (void)viewDidLoad
{
    ...
    NSString *path=[[NSBundle mainBundle] pathForResource:@"slide01" ofType:@"html" inDirectory:@"Bortract"];
