...
@interface Evermil_brand_Home ()

@end

@implementation Evermil_brand_Home
@synthesize web;
...
- (void)viewDidLoad
{
    ...
    NSString *path=[[NSBundle mainBundle] pathForResource:@"slide01" ofType:@"html" inDirectory:@"Evermil"];
