...
@interface Glenstim_brand_Home ()

@end

@implementation Glenstim_brand_Home
@synthesize web;
...
- (void)viewDidLoad
{
    ...
    NSString *path=[[NSBundle mainBundle] pathForResource:@"slide01" ofType:@"html" inDirectory:@"Glenstim"];
