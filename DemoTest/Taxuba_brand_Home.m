...
@interface Taxuba_brand_Home ()

@end

@implementation Taxuba_brand_Home
@synthesize web;
...
- (void)viewDidLoad
{
    ...
    NSString *path=[[NSBundle mainBundle] pathForResource:@"page01" ofType:@"html" inDirectory:@"Taxuba"];
