...
@interface Aprecap_Page2 ()

@end

@implementation Aprecap_Page2
@synthesize web;
...
//    NSLog(@"%@ array : ",myArray);
    ...
    NSString *path=[[NSBundle mainBundle] pathForResource:@"slide02" ofType:@"html" inDirectory:@"Aprecap"];
...
- (IBAction)prevAction:(id)sender {
    if (position == 0) {
//        NSLog(@"i am here");exit(0);
    }else{
        position--;
        val--;
    }
    
    NSLog(@"position 4th : %d",position);
