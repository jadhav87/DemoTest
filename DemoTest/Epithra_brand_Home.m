...
@interface Epithra_brand_Home ()

@end

@implementation Epithra_brand_Home
@synthesize web;
...
- (void)viewDidLoad
{
    ...
    NSString *path=[[NSBundle mainBundle] pathForResource:@"page01" ofType:@"html" inDirectory:@"Epithra"];
