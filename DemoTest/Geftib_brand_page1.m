...
@interface Geftib_brand_page1 ()

@end

@implementation Geftib_brand_page1
...
- (void)viewDidLoad
{
    ...
    NSString *path=[[NSBundle mainBundle] pathForResource:@"slide02" ofType:@"html" inDirectory:@"Geftib"];
